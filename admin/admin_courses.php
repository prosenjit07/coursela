...
<main>
    ...
    if (isset($_GET['add']) || isset($_POST['add'])) {
        if (isset($_POST['add'])) {
            ...
            $price = sanitize_data($_POST['price'], $conn);
            ...
            if (empty($_FILES['fileToUpload']['name'])) {
                ...
                $img = upload_img();
                if ($img !== FALSE) {
                    $sql = "INSERT INTO course(course_name,course_author,course_desc,course_dur,course_img,price)  VALUES ('$name','$author','$desc','$dur','$img','$price')";
                    if ($conn->query($sql))
    ...
    <?php
        ...
        if (isset($_POST['edit'])) {
            ...
            if (!empty($_FILES['fileToUpload']['name'])) {
                ...
                $sql = "UPDATE course SET course_name='$name', course_author='$author', course_desc='$desc', course_dur='$dur', price='$price' " . $img . " WHERE course_id=$id";
                if ($conn->query($sql)) {
